<template>
    <div class="flex min-h-screen bg-custom-5">
        <div class="bg-primary flex-1">
            ...
            <ForEmployers />
            <p
                class="text-[50px] text-white mt-[177px]"
        ...
        <form
            ...
            class="px-12 flex flex-col items-center justify-center flex-1 bg-custom-5 text-primary overflow-hidden"
        >
            <Circles class="top-[91.44px]" />
            <p class="mt-40 font-extrabold text-[32px] text-primary mb-[43px] self-start">Login</p>
            <div class="w-full">
                <label class="mb-13 text-[18px]">Email</label>
                <input
                    class="block bg-white rounded-[10px] border-primary border-[0.5px] p-2 w-full text-[18px] p-[23px]"
                    type="text"
                    v-model="email"
                />
            </div>
            <div class="w-full mt-[42px]">
                <label class="mb-13 text-[18px]">Password</label>
                <input
                    class="block bg-white rounded-[10px] border-primary border-[0.5px] p-2 w-full text-[18px] p-[23px]"
                    type="text"
                    v-model="password"
            ...
            <div class="mt-[40px] self-start">
                <button
                    type="submit"
                    class="bg-primary px-[62.5px] py-[23px] rounded-[10px] text-white text-[18px] leading-[22px] tracking-[0.12em]"
